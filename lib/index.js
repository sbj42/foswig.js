 ...
 * @param {Function} random The random number generator to use (must behave like Math.random, which is the default)
 */
module.exports.prototype.generateWord = function(minLength,maxLength,allowDuplicates,maxAttempts,random) {
